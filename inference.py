"""
nohup python inference_transformers.py \
    --prompts_dir=prompts \
    --output_dir='' \
    --model_name=/home/models/Meta-Llama-3.2-3B-Instruct \
    --batch_size=10 > logs/[Meta-Llama-3.2-3B-Instruct]_[cuda:0] \
    ;
"""
...
if __name__ == "__main__":
    ...
    if args.prompts_dir is not None:
        filenames = glob.glob(f"{args.prompts_dir}/*.pkl")
